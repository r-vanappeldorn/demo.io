...
func NewClient(cnf *config.Env) (ClientHelper, error) {
	c, err := mongo.NewClient(options.Client().ApplyURI(cnf.MongoUri))
	return &mongoClient{cl: c}, err
}

func NewDatabase(cnf *config.Env, client ClientHelper) DatabaseHelper {
